...
@Mixin(targets = "com.raoulvdberge.refinedstorage.apiimpl.autocrafting.task.Processing", remap = false) public abstract class ProcessingMixin implements IProcessingAccessor {
